 ...
 *
 */
public class EntreAddon implements Addon {
    ...
    public void onInstall(AddonInfo addonInfo) {
         ...
         */
        System.out.println("Entre Addon onInstall");
    ...
    public void onUninstall(AddonInfo addonInfo) {
        ...
        System.out.println("Entre Addon onUninstall");
    }
    ...
    public void onStart(AddonInfo addonInfo) {
        ...
        System.out.println("Entre Addon onStart");
    }
    ...
    public void onStop(AddonInfo addonInfo) {
        ...
        System.out.println("Entre Addon onStop");
